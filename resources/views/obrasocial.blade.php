            ...
            <div class="form-group">
              ...
              <div class="form-group col-lg-12">
                ...
                <div class="input-group col-lg-12">
                    ...
                    <label for="valorSesion">Valor de Sesión</label>
                
                    <div class="input-group">
                    
                      <span class="input-group-addon"><i class="fa fa-money"></i></span> 

                      <input type="text" class="form-control input-lg" name="valorSesion" placeholder="Valor de Sesión">
                  ...
                  <div class="col-lg-4">
                    ...
                    <label for="valorKm">Valor de KM</label>
                
                    <div class="input-group">
                    
                      <span class="input-group-addon"><i class="fa fa-money"></i></span> 

                      <input type="text" class="form-control input-lg" name="valorKm" placeholder="Valor KM">
                  ...
                  <div class="col-lg-4">
                    ...
                    <label for="valorModulo">Valor de Módulo</label>
                
                      <div class="input-group">
                      
                        <span class="input-group-addon"><i class="fa fa-money"></i></span> 

                        <input type="text" class="form-control input-lg" name="valorModulo" placeholder="Valor de Módulo">
              ...
              <div class="form-group">
                ...
                <div class="form-group col-lg-12">
                  ...
                  <div class="input-group col-lg-12">
                      ...
                      <label for="editarValorSesion">Valor de Sesión</label>
                  
                      <div class="input-group">
                      
                        <span class="input-group-addon"><i class="fa fa-money"></i></span> 

                        <input type="text" class="form-control input-lg" id="editarValorSesion" name="editarValorSesion" placeholder="Valor de Sesión">
                    ...
                    <div class="col-lg-4">
                      ...
                      <label for="editarValorKm">Valor de KM</label>
                  
                      <div class="input-group">
                      
                        <span class="input-group-addon"><i class="fa fa-money"></i></span> 

                        <input type="text" class="form-control input-lg" id="editarValorKm" name="editarValorKm" placeholder="Valor KM">
                    ...
                    <div class="col-lg-4">
                      ...
                      <label for="editarValorModulo">Valor de Módulo</label>
                  
                        <div class="input-group">
                        
                          <span class="input-group-addon"><i class="fa fa-money"></i></span> 

                          <input type="text" class="form-control input-lg" id="editarValorModulo" name="editarValorModulo" placeholder="Valor de Módulo">
