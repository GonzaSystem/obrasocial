		...
		<main class="content-print container osecac" style="padding-top: 1.5rem;">
			...
			<div class="form" style="margin-top: 0.5rem; padding: 0 0.5rem">
				<div class="form-group" style="width: 30%; margin-top: 0.4rem;">
					...
					>
					<input id="emition-date-day" type="text" class="form-input" value="{{date('d')}}"/>
					<span class="form-prepend text" style="font-size: 0.8rem;">/</span>
					<input id="emition-date-month" type="text" class="form-input" value="{{date('m')}}"/>
					<span class="form-prepend text" style="font-size: 0.8rem;">/</span>
					<input id="emition-date-year" type="text" class="form-input" value="{{date('Y')}}"/>
				</div>
				<div class="row">
				...
				<div class="form-group" style="margin-top: 0.1rem;">
					<span class="form-prepend text" style="font-size: 0.8rem;"
						>Domicilio:</span
					>
					<input id="address" type="text" class="form-input" value="{{ $prestador[0]->user->direccion }}"/>
				</div>
				<div class="row">
					<div class="form-group" style="margin-top: 0.1rem;">
						<span class="form-prepend text" style="font-size: 0.8rem;"
								...
								>
									...
									>
										<span class="form-prepend text" style="font-size: 0.8rem;"
											>Desde:</span
										>
										<input id="from-going" type="text" class="form-input" value="{{$beneficiario->direccion . ' ' . $beneficiario->localidad}}"/>
									</div>
									<div
										class="form-group"
										style="width: 100%; margin-top: 0.3rem;"
									>
										<span class="form-prepend text" style="font-size: 0.8rem;"
											>Hasta:</span
										>
										<input id="to-going" type="text" class="form-input" value="{{$beneficiario->direccion_prestacion . ' ' . $beneficiario->localidad_prestacion}}"/>
									</div>
								</div>
							</td>
						</tr>
								...
								>
									...
									>
										<span class="form-prepend text" style="font-size: 0.8rem;"
											>Desde:</span
										>
										<input id="from-back" type="text" class="form-input" value="{{$beneficiario->direccion_prestacion . ' ' . $beneficiario->localidad_prestacion}}"/>
									</div>
									<div
										class="form-group"
										style="width: 100%; margin-top: 0.4rem;"
									>
										<span class="form-prepend text" style="font-size: 0.8rem;"
											>Hasta:</span
										>
										<input id="to-back" type="text" class="form-input" value="{{$beneficiario->direccion . ' ' . $beneficiario->localidad}}"/>
									</div>
								</div>
							</td>
						</tr>
